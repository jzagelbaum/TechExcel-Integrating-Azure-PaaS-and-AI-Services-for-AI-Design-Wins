...
[KernelFunction]
   ...
   [KernelFunction]
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate( [Description("The ID of the hotel")] int hotelId, [Description("The specified date to search after")] DateTime dt)
    {
...
[KernelFunction]
    [Description("Get all bookings missing an assigned hotel room.")]
